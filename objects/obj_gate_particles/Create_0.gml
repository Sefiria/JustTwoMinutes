...
// Set the movement direction of the light particle,
// which is based on the 'light_direction' variable
// defined in the Variable Definitions of this object
// The 'light_direction_increase' variable from the
// Variable Definitions is also used
part_type_direction(light, light_direction - 30, light_direction + 30, light_direction_increase, 0.5);

// Create an emitter to continually emit particles
// in our system
light_emitter = part_emitter_create(part_sys);

// Set the region where this emitter will create particles
// The region is based on the bounding box of this instance
// (its actual dimensions in the room)
...
// The count is taken from the 'light_count' variable defined in the
